...
function addQuestionBlock() {
    ...
    const blockId = 'question-block-' + questionCounter;
    
    const blockHTML = `
        <div id="${blockId}" class="question-input bg-white rounded-2xl shadow-xl p-6">
            <div class="flex justify-between items-center mb-4">
                <h3 class="text-lg font-bold text-blue-600">Question #${questionCounter + 1}</h3>
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <textarea id="question-${questionCounter}" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:border-blue-500 focus:outline-none" rows="3" placeholder="Enter your question text here..."></textarea>
                </div>
                
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-1">Subject</label>
                        <select id="subject-${questionCounter}" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:border-blue-500 focus:outline-none">
                    ...
                    <div>
                        ...
                        <input type="text" id="year-${questionCounter}" placeholder="e.g., 2024-2025" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:border-blue-500 focus:outline-none">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <select id="examType-${questionCounter}" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:border-blue-500 focus:outline-none">
                            <option value="">Use Default</option>
                    ...
                    <div>
                        ...
                        <select id="difficulty-${questionCounter}" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:border-blue-500 focus:outline-none">
                            <option value="">Use Default</option>
                ...
                <div>
                    ...
                    <input type="text" id="topic-${questionCounter}" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:border-blue-500 focus:outline-none" placeholder="e.g., Calculus, Thermodynamics, Shakespeare">
                </div>
                ...
                <div>
                    ...
                    <div id="options-${questionCounter}">
                        <div class="flex items-center gap-2 mb-2">
                            ...
                            <input type="text" 
                                   id="option-${questionCounter}-0" 
                                   class="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:border-blue-500 focus:outline-none"
                                   placeholder="Option A">
                            <label class="flex items-center gap-1">
                                <input type="radio" name="correct-${questionCounter}" id="correct-${questionCounter}-0" value="0">
                        ...
                        <div class="flex items-center gap-2 mb-2">
                            ...
                            <input type="text" 
                                   id="option-${questionCounter}-1" 
                                   class="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:border-blue-500 focus:outline-none"
                                   placeholder="Option B">
                            <label class="flex items-center gap-1">
                                <input type="radio" name="correct-${questionCounter}" id="correct-${questionCounter}-1" value="1">
                                <span class="text-sm">Correct</span>
                            </label>
                        </div>
                        <div class="flex items-center gap-2 mb-2">
                            ...
                            <input type="text" 
                                   id="option-${questionCounter}-2" 
                                   class="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:border-blue-500 focus:outline-none"
                                   placeholder="Option C">
                            <label class="flex items-center gap-1">
                                <input type="radio" name="correct-${questionCounter}" id="correct-${questionCounter}-2" value="2">
                                <span class="text-sm">Correct</span>
                            </label>
                        </div>
                        <div class="flex items-center gap-2 mb-2">
                            ...
                            <input type="text" 
                                   id="option-${questionCounter}-3" 
                                   class="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:border-blue-500 focus:outline-none"
                                   placeholder="Option D">
                            <label class="flex items-center gap-1">
                                <input type="radio" name="correct-${questionCounter}" id="correct-${questionCounter}-3" value="3">
                                <span class="text-sm">Correct</span>
                            </label>
                        </div>
                    </div>
                    <button type="button" onclick="addOptionField(${questionCounter})" class="mt-2 px-3 py-1 bg-green-500 text-white text-sm rounded hover:bg-green-600">
                        ➕ Add Option
                    </button>
                </div>
                ...
                <div>
                    ...
                    <textarea id="explanation-${questionCounter}" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:border-blue-500 focus:outline-none" rows="3" placeholder="Provide explanation for the correct answer..."></textarea>
                </div>
            </div>
        </div>
    `;

...
exports.RoleSchema = exports.Role = exports.RoleType = void 0;
...
var Role = function () {
    ...
    var Role = _classThis = /** @class */ (function (_super) {
        ...
        function Role_1() {
            ...
            _this.modules = (__runInitializers(_this, _permissions_extraInitializers), __runInitializers(_this, _modules_initializers, void 0));
            __runInitializers(_this, _modules_extraInitializers);
            return _this;
        }
        return Role_1;
    }(_classSuper));
    ...
    (function () {
        ...
        _name_decorators = [(0, mongoose_1.Prop)({ required: true, unique: true, enum: RoleType })];
        _description_decorators = [(0, mongoose_1.Prop)({ required: true })];
        _permissions_decorators = [(0, mongoose_1.Prop)({ type: [String], default: [] })];
        _modules_decorators = [(0, mongoose_1.Prop)({ type: [String], default: [] })];

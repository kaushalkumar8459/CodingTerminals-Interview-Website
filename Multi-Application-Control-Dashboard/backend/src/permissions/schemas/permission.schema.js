...
var Permission = function () {
    ...
    var Permission = _classThis = /** @class */ (function (_super) {
        ...
        function Permission_1() {
            ...
            _this.module = (__runInitializers(_this, _description_extraInitializers), __runInitializers(_this, _module_initializers, void 0));
            _this.action = (__runInitializers(_this, _module_extraInitializers), __runInitializers(_this, _action_initializers, void 0));
            __runInitializers(_this, _action_extraInitializers);
            return _this;
        }
        return Permission_1;
    }(_classSuper));
    ...
    (function () {
        ...
        _module_decorators = [(0, mongoose_1.Prop)({ required: true })];
        _action_decorators = [(0, mongoose_1.Prop)({ enum: ['create', 'read', 'update', 'delete'], required: true })];

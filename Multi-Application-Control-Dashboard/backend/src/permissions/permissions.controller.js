...
var PermissionsController = function () {
    var _classDecorators = [(0, common_1.Controller)('permissions'), (0, common_1.UseGuards)(auth_guard_1.JwtAuthGuard)];
    ...
    var PermissionsController = _classThis = /** @class */ (function () {
        ...
        PermissionsController_1.prototype.create = function (createPermissionDto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.permissionsService.create(createPermissionDto)];
                });
            });
        };
        PermissionsController_1.prototype.findAll = function (module) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    if (module) {
                        return [2 /*return*/, this.permissionsService.findByModule(module)];
                    }
                    return [2 /*return*/, this.permissionsService.findAll()];
                });
            });
        };
        PermissionsController_1.prototype.findOne = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.permissionsService.findOne(id)];
                });
            });
        };
        PermissionsController_1.prototype.update = function (id, updatePermissionDto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.permissionsService.update(id, updatePermissionDto)];
                });
            });
        };
        PermissionsController_1.prototype.delete = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.permissionsService.delete(id)];
                });
            });
        };

...
var AuthController = function () {
    ...
    var AuthController = _classThis = /** @class */ (function () {
        ...
        AuthController_1.prototype.getMe = function (req) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.authService.getUserWithDetails(req.user.sub)];
                });
            });
        };
        AuthController_1.prototype.refresh = function (refreshTokenDto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.authService.refreshToken(refreshTokenDto.refreshToken)];
                });
            });
        };
        AuthController_1.prototype.logout = function (req) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.authService.logout(req.user.sub)];
                        case 1:
                            _a.sent();
    ...
    (function () {
        ...
        _login_decorators = [(0, common_1.UseGuards)(auth_guard_1.LocalAuthGuard), (0, common_1.Post)('login'), (0, common_1.HttpCode)(common_1.HttpStatus.OK)];
        _getMe_decorators = [(0, common_1.Get)('me'), (0, common_1.UseGuards)(auth_guard_1.JwtAuthGuard)];
        _refresh_decorators = [(0, common_1.Post)('refresh'), (0, common_1.HttpCode)(common_1.HttpStatus.OK)];
        _logout_decorators = [(0, common_1.UseGuards)(auth_guard_1.JwtAuthGuard), (0, common_1.Post)('logout'), (0, common_1.HttpCode)(common_1.HttpStatus.OK)];
        _getProfile_decorators = [(0, common_1.UseGuards)(auth_guard_1.JwtAuthGuard), (0, common_1.Get)('profile')];

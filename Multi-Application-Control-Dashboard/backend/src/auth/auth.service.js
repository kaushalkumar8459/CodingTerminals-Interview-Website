    ...
    var AuthService = _classThis = /** @class */ (function () {
        ...
        AuthService_1.prototype.register = function (registerDto) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.userModel.findOne({ email: registerDto.email })];
                        case 1:
                        ...
                        case 2:
                            ...
                            user = new this.userModel(__assign(__assign({}, registerDto), { password: hashedPassword, role: registerDto.role || role_schema_1.RoleType.VIEWER }));
        ...
        AuthService_1.prototype.login = function (user) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.userModel.updateOne({ _id: user._id }, { lastLogin: new Date() })];
                        case 1:
                            _a.sent();
                            return [2 /*return*/, this.generateTokens(user)];
                    }
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.userModel.updateOne({ _id: user._id || user.id }, { refreshToken: refreshToken })];
                        case 1:
                            _a.sent();
                            return [2 /*return*/, {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.userModel.findById(payload.sub)];
                        case 1:
                            user = _a.sent();
        ...
        AuthService_1.prototype.logout = function (userId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.userModel.updateOne({ _id: userId }, { refreshToken: null })];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
        ...
        AuthService_1.prototype.getUserWithDetails = function (userId) {
            return __awaiter(this, void 0, void 0, function () {
                var user;
                return __generator(this, function (_a) {
                    switch (_a.label) {

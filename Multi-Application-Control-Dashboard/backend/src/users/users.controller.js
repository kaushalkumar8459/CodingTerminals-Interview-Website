...
var UsersController = function () {
    var _classDecorators = [(0, common_1.Controller)('users'), (0, common_1.UseGuards)(auth_guard_1.JwtAuthGuard)];
    ...
    var UsersController = _classThis = /** @class */ (function () {
        ...
        UsersController_1.prototype.assignRole = function (id, role) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.usersService.assignRole(id, role)];
                });
            });
        };
        UsersController_1.prototype.assignModules = function (id, moduleIds) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.usersService.assignModules(id, moduleIds)];
                });
            });
        };
    ...
    (function () {
        ...
        _assignRole_decorators = [(0, common_1.Post)(':id/role')];

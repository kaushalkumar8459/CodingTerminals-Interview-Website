...
var BlogController = function () {
    var _classDecorators = [(0, common_1.Controller)('blog'), (0, common_1.UseGuards)(auth_guard_1.JwtAuthGuard)];
    ...
    var BlogController = _classThis = /** @class */ (function () {
        ...
        BlogController_1.prototype.create = function (createBlogDto, req) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.blogService.create(__assign(__assign({}, createBlogDto), { author: req.user.sub }))];
                });
            });
        };
        BlogController_1.prototype.findAll = function (status) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.blogService.findAll(status)];
                });
            });
        };
        ...
        BlogController_1.prototype.getStats = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.blogService.getStats()];
                });
            });
        };
        BlogController_1.prototype.findByAuthor = function (authorId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.blogService.findByAuthor(authorId)];
                });
            });
        };
        BlogController_1.prototype.findOne = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
        ...
        BlogController_1.prototype.update = function (id, updateBlogDto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.blogService.update(id, updateBlogDto)];
                });
            });
        };
        ...
        BlogController_1.prototype.publish = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.blogService.publish(id)];
                });
            });
        };
        BlogController_1.prototype.unpublish = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.blogService.unpublish(id)];
                });
            });
        };
    ...
    (function () {
        ...
        __esDecorate(_classThis, null, _unpublish_decorators, { kind: "method", name: "unpublish", static: false, private: false, access: { has: function (obj) { return "unpublish" in obj; }, get: function (obj) { return obj.unpublish; } }, metadata: _metadata }, null, _instanceExtraInitializers);

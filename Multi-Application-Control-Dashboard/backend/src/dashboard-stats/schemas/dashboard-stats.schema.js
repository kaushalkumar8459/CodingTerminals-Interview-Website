...
var DashboardStats = function () {
    ...
    var DashboardStats = _classThis = /** @class */ (function () {
        function DashboardStats_1() {
            ...
            this.createdAt = (__runInitializers(this, _value_extraInitializers), __runInitializers(this, _createdAt_initializers, void 0));
            this.updatedAt = (__runInitializers(this, _createdAt_extraInitializers), __runInitializers(this, _updatedAt_initializers, void 0));
            __runInitializers(this, _updatedAt_extraInitializers);
        }
        return DashboardStats_1;
    }());
    __setFunctionName(_classThis, "DashboardStats");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _module_decorators = [(0, mongoose_1.Prop)({ type: String, required: true })];
        _metric_decorators = [(0, mongoose_1.Prop)({ type: String, required: true })];
        _value_decorators = [(0, mongoose_1.Prop)({ type: Number, default: 0 })];
        ...
        DashboardStats = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return DashboardStats = _classThis;
}();
